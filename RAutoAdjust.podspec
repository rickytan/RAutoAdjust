Pod::Spec.new do |s|
  s.name         = "RAutoAdjust"
  s.version      = "1.0.0"
  s.summary      = "a drop-in replacement of UITextField and UITextView which can automatically adjust window position to make itself visible when keyboard pop out"
